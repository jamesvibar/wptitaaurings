...
var _default = Map;
exports.default = _default;
},{"google-maps":"../../node_modules/google-maps/lib/Google.js"}],"../../node_modules/ev-emitter/ev-emitter.js":[function(require,module,exports) {
var define;
...
},{"./flickity":"../../node_modules/flickity/js/flickity.js","./drag":"../../node_modules/flickity/js/drag.js","./prev-next-button":"../../node_modules/flickity/js/prev-next-button.js","./page-dots":"../../node_modules/flickity/js/page-dots.js","./player":"../../node_modules/flickity/js/player.js","./add-remove-cell":"../../node_modules/flickity/js/add-remove-cell.js","./lazyload":"../../node_modules/flickity/js/lazyload.js"}],"components/foodMenuSlider.js":[function(require,module,exports) {
"use strict";
...
/*#__PURE__*/
function () {
  function FoodMenuSlider(element) {
    _classCallCheck(this, FoodMenuSlider);

    this.el = document.body.querySelector(element);
    if (!this.el || _typeof(this.el) === undefined || this.el.length === 0) return;
    this.init();
  }

  _createClass(FoodMenuSlider, [{
    key: "init",
    value: function init() {
      var flkty = new _flickity.default(this.el, {
        cellAlign: "left",
        groupCells: 2,
        freeScroll: true,
        pageDots: false
  ...
  return FoodMenuSlider;
}();

var _default = FoodMenuSlider;
exports.default = _default;
},{"flickity":"../../node_modules/flickity/js/index.js"}],"../../node_modules/gsap/TweenLite.js":[function(require,module,exports) {
var global = arguments[3];
"use strict";
...
function () {
  function MenuToggle() {
    ...
    if (!this.menu || _typeof(this.menu) === undefined || this.menu.length === 0) return;
    this.init();
  }
  ...
  _createClass(MenuToggle, [{
    ...
    value: function toggleButton() {
      ...
      var tNav = new _gsap.TimelineLite({
        paused: true
      });
      ...
      if (!this.menu.classList.contains("is-active")) {
        ...
        _gsap.TweenLite.set(this.menu, {
          display: "flex"
        });

        tNav.add("start").to(this.menu, 0.5, {
          autoAlpha: 1,
        ...
        new _gsap.TimelineLite({
          paused: true,
          onComplete: function onComplete() {
            _gsap.TweenLite.set(_this.menu, {
              display: "none"
            });
          }
        }).add("start").to(this.menu, 0.5, {
          autoAlpha: 0,
          ease: _gsap.Power3.easeInOut
        }).play();
      }
...
exports.default = _default;
},{"gsap":"../../node_modules/gsap/index.js"}],"../../node_modules/smooth-scroll/dist/smooth-scroll.polyfills.min.js":[function(require,module,exports) {
var define;
var global = arguments[3];
...
var _foodMenuSlider = _interopRequireDefault(require("./components/foodMenuSlider"));
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var foodSlider = new _foodMenuSlider.default("#foodMenuSlider");
  /**
   * Initialize the Mobile Menu.
   * @params {String} el - class/id of the menu
   */

  var menuToggle = new _menuToggle.default(); // Smooth scroll on click

  var smoothScroll = new _smoothScroll.default('a[href*="#"]');
});
},{"../scss/main.scss":"../scss/main.scss","./components/topbar":"components/topbar.js","./components/map":"components/map.js","./components/foodMenuSlider":"components/foodMenuSlider.js","./components/menuToggle":"components/menuToggle.js","smooth-scroll":"../../node_modules/smooth-scroll/dist/smooth-scroll.polyfills.min.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
